...
$(package)_qt_libs=corelib network widgets gui plugins testlib qlalr xml concurrent
...
define $(package)_stage_cmds
  $(MAKE) -C src INSTALL_ROOT=$($(package)_staging_dir) $(addsuffix -install_subtargets,$(addprefix sub-,$($(package)_qt_libs))) && \
  $(MAKE) INSTALL_ROOT=$($(package)_staging_dir) sub-qmake-qmake-aux-pro-install_subtargets && \
  $(MAKE) INSTALL_ROOT=$($(package)_staging_dir) install_mkspecs && cd .. && \
